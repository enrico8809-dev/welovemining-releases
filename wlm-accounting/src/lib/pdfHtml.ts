// The letterhead: every document this app prints, as HTML.
//
// Kept apart from pdf.ts because that file reaches for expo-print, which has no
// desktop equivalent. The markup is the same on both — an invoice from the
